...
import { ChapterResponse, BaseResponse, ChapterSearchRequest } from 'src/app/model/model';
...
export class ChapterServicesService {
  ...
  searchSlect2(chapter : ChapterSearchRequest): Observable<ChapterResponse[]> {
    return this.http.post<ChapterResponse[]>(this.baseUrl + '/search', chapter);

  }

  // searchPaging(page: PagesRequest,chapter: Chapter): Observable<BasePagingResponse<ChapterSearchResponse>> {
  ...
  //   console.log(params)
  //   return this.http.get<BasePagingResponse<ChapterSearchResponse>>(this.baseUrl, {
  //     params,
  //   });
  // }
}
